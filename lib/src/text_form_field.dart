...
/// A [FormField] that contains a [CustomTextField].
///
...
///
/// For a documentation about the various parameters, see [CustomTextField].
///
/// {@tool snippet}
///
...
class CustomTextFormField extends FormField<String> {
  ...
  ///
  /// For documentation about the various parameters, see the [CustomTextField] class
  /// and [CustomTextField.new], the constructor.
  CustomTextFormField({
    super.key,
    this.controller,
    String? initialValue,
